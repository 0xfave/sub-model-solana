...
#[tokio::test]
async fn test_10_grace_deadline() {
    ...
    let expected_grace = sub.current_period_end + (3 * 24 * 60 * 60); // 3 days grace
    
    assert_eq!(grace_deadline, expected_grace, "Grace deadline should be period end + 3 days");
}
